...
private static final DateTimeFormatter FORMATTER = org.joda.time.format.DateTimeFormat
...
public void testJodaTime() {
    ...
    long millis = FORMATTER.parseMillis(stringDate);
    assertEquals(stringDate, FORMATTER.print(millis));
}
